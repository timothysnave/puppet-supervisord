...
class supervisord(
  ...
  $config_include_owner = $supervisord::params::config_include_owner,
  $config_include_group = $supervisord::params::config_include_group,
  $config_include_mode  = $supervisord::params::config_include_mode,
